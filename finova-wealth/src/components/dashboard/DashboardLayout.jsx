      ...
      {sidebarOpen && (
        <div className="border-t border-surface-100 p-4">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white font-semibold text-sm">PS</div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-surface-900 truncate">Prateek Sharma</p>
              <p className="text-xs text-surface-400 truncate">prateek@email.com</p>
            </div>
...
>>>>>>> d2fc22b (Updated backend engine and finova-wealth)
            ...
            <NavLink to="/profile" className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-lg hover:bg-surface-50">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-accent-500 flex items-center justify-center text-white font-semibold text-xs">PS</div>
              <span className="text-sm font-medium text-surface-700 hidden sm:block">Prateek</span>
            </NavLink>
          </div>
        </header>
